...
const fonts = [
    'src/fonts/HelveticaNeue-Light/*.*',
    'src/fonts/HelveticaNeue-Medium/*.*',
    'src/fonts/HelveticaNeue-Regular/*.*'
];
...
/*task('styles:header', () => {
    return src('src/sass/_header.sass')
        .pipe(gulpif(env === 'dev', sourcemaps.init()))
...
task('watch', () => {
    ...
    //watch('./src/sass/_header.sass', series("styles:header"));
